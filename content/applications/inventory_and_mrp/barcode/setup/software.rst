...
To use Barcode Lookup in Barcode, go to :menuselection:`Inventory --> Configuration --> Settings`,
scroll down to the :guilabel:`Barcode` section, and enable :guilabel:`Stock Barcode Database`.
