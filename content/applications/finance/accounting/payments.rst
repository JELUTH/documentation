...
journal entry and sets the amount due according to the payment amount. The counterpart is
...
information about the payment. To access additional information, such as the related journal entry,
click :guilabel:`View`.
...
list view of payments, to group several payments in a batch, select them and click
